export const en = {
  ...
  nav: {
    ...
    decentralised: "Taxes & Fees — Decentralised Entities",
    customs: "Customs",
  ...
  home: {
    ...
    contact: {
      ...
      subtitle: "Get in touch with RRA for support and assistance",
      callCenter: {
        title: "Call Center",
  ...
  auth: {
    login: {
      title: "Sign In",
      subtitle: "Access your Rwanda Revenue Authority account",
      role: "Login as",
      taxpayer: "Taxpayer",
      admin: "Admin",
      email: "Email Address",
    ...
    signup: {
      ...
      subtitle: "Join the Rwanda Revenue Authority portal",
